...
タスク成果物は、1タスクの認識合わせ、計画、完了レビューをチャット履歴ではなくファイルとして残すための置き場です。

devlogは作業後の判断ログです。
タスク成果物は、実装前後の合意内容と確認結果を残します。

## 基本ルール

- 1タスクにつき1つのタスク成果物フォルダを作る
- requirement alignment、implementation plan、completion reviewはチャットだけに残さない
- 小さいMinimal作業では短くしてよいが、目的、範囲、検証方法、完了判断は残す
- devlogは従来どおり `docs/devlog/` に残し、タスク成果物からリンクする
- ADRを作成した場合は、タスク成果物とdevlogの両方からリンクする
